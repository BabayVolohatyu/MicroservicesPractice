...
(function () {
  ...
  function showCopiedFeedback() {
    ...
    msg.style.cssText =
      "position:fixed;bottom:16px;right:16px;background:#333;color:#fff;padding:6px 12px;border-radius:4px;font-size:12px;z-index:99999;pointer-events:none;";
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    style.textContent =
      ".swagger-ui pre.microlight, .swagger-ui .opblock-body pre, .swagger-ui .response-body pre, .swagger-ui .body-param__content pre, .swagger-ui pre.highlight-code { cursor: pointer; user-select: none; } .swagger-ui pre.microlight:hover, .swagger-ui .opblock-body pre:hover, .swagger-ui .response-body pre:hover, .swagger-ui .body-param__content pre:hover { outline: 1px solid rgba(0,0,0,0.1); outline-offset: 2px; }";
